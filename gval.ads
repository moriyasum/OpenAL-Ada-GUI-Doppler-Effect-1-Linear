...
--  For Draw parameters ------
   ...
   S_X_Len_M : Float := 4.0;       --  Source Length meter
...
--  16bit WAV store type
   ...
   --
   Scale_Value : Glib.Gdouble;  --  Listner Volume Variable
   Source_Gain : constant Float := 1.0;  --  Source Volume is constant
...
--  Buffer_Arrt : OpenAL.Buffer.Buffer_Array_t (1 .. 2000000); --  WAV MAX Word
   WAV_Buffers : OpenAL.Buffer.Buffer_Array_t (1 .. 1);
--
