...
procedure Gui_Doppler_Linear_1 is
   ...
   Entry_L1, Entry_L2, Entry_L3, Entry_L4 : Gtk_Label;
   --  Entry Box
   ...
   Scale_Volume_Slider : Gtk.Scale.Gtk_Hscale;
...
----------------------------
   Gtk.Scale.Gtk_New_Hscale
     (Scale => Scale_Volume_Slider,   -- Gtk.Scale
      Min => Glib.Gdouble (0.5),
      Max => Glib.Gdouble (10),
      Step => Glib.Gdouble (0.5));

   Set_Value_Pos (Scale_Volume_Slider, Pos_Bottom); --  Current value position
   Gtk.Scale.Set_Value (Scale_Volume_Slider, 1.0);  --  Set Default value
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 0.5, Gtk.Enums.Pos_Top, "0.5");
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 1.0, Gtk.Enums.Pos_Top, "1");
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 3.0, Gtk.Enums.Pos_Top, "3");
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 5.0, Gtk.Enums.Pos_Top, "5");
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 7.0, Gtk.Enums.Pos_Top, "7");
   Gtk.Scale.Add_Mark (Scale_Volume_Slider, 10.0, Gtk.Enums.Pos_Top, "10");

   Vbox_1M.Pack_Start
     (Scale_Volume_Slider, Expand => False, Fill => False, Padding => 30);

   Scale_Volume_Callback.Connect
     (Scale_Volume_Slider, "value-changed",
      Scale_Volume_Callback.To_Marshaller (Process.On_Scale_Volume_Cb'Access));
   --
   Scale_Value := Gtk.Scale.Get_Value (Scale_Volume_Slider);
--
--
--
--------------------------
